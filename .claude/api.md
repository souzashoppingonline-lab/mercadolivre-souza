...
| `GET /api/pedidos/:id/detalhes` | pedido completo com cálculo de margem (custo, imposto, tarifa, fretes). Traz `freteMotoboyAplicado` (bool) quando o custo motoboy Flex (v85) substituiu o frete do vendedor nesta venda |
