...
| `GET /api/shopee/problemas?store_id` | Painel de Problemas Shopee — `{categorias:{pedidos_atrasados,anuncios_pausados,sem_estoque,sem_imagem,pedidos_cancelados}:{total,itens[],acao}, indisponiveis:['reclamacoes','reembolsos'], nota_indisponiveis}`. Tudo `marketplace_id=SHOPEE` |
