...
tarifa_manual NUMERIC                    -- v84: edição manual da tarifa (botão ✏️ em
                                   -- bi-vendas.html) — maior precedência de todas as
                                   -- fontes em calcularMargemLinha/CASE WHEN (vence
                                   -- Conciliação/ml_payments/ml_fee). NULL = sem edição,
