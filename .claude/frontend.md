...
- **Módulos** (fora do menu Operacional — sistema próprio via switcher no topbar, ver `modules.md`): financeiro (`pages/financeiro.html`, layout `js/layout-financeiro.js`), inteligencia-negocio (`pages/inteligencia-negocio.html`, layout `js/layout-bi.js`) — ambas "em construção" hoje
