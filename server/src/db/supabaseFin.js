...
const WRITE_ALLOW = new Set(['sales_entries', 'expenses', 'expense_categories', 'boletos_mensais', 'receivables', 'boleto_categories', 'cartoes', 'parcelas_cartao', 'parcela_tags', 'fatura_pagamentos', 'boletos_recorrentes', 'cash_flow_entries', 'cash_flow_categories', 'cash_flow_recurring', 'contas_bancarias', 'conta_empresas', 'manual_cash_flow_values', 'forecast_starting_balance']);
