...
const MODULES = {
  ...
  bi:          { label: 'Inteligência de Negócio', roles: ['admin'], pages: ['/pages/inteligencia-negocio.html', '/pages/bi-vendas.html', '/pages/bi-margem.html', '/pages/bi-margem-produtos.html', '/pages/bi-margem-portfolio.html', '/pages/bi-margem-frete.html', '/pages/bi-margem-estoque.html', '/pages/bi-margem-acoes.html', '/pages/bi-rankeamento.html', '/pages/agente-financeiro.html', '/pages/analista-ecom.html'], apiPrefixes: ['/api/bi'] },
};
