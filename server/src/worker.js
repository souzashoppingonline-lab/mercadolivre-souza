    ...
    for (const p of rows) {
      ...
      if (dias >= 1) {
        ...
        if (p.expiry_alert_min_days == null || dias < p.expiry_alert_min_days) {
          ...
          // Agenda Trello — Regra 5 (cartão pra campanha vencendo) REMOVIDA a
          // pedido do usuário (v105); o alerta Telegram/e-mail abaixo continua
          // igual, era a única fonte real de notificação — o cartão só
          // duplicava. Ver task-engine.md/decisions.md.
        }
